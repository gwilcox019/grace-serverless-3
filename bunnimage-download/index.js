...
module.exports = async function (context, req) {
    ...
    var download = ""
    var downloadpng = "https://wilcoxserverless1.blob.core.windows.net/images/" + username + ".png";
    var downloadjpg = "https://wilcoxserverless1.blob.core.windows.net/images/" + username + ".jpeg";
